...
const categories = [
  { title: "Kitchen Designs", image: kitchenImg, link: "/services/kitchen-design" },
  { title: "Office Interiors", image: officeImg, link: "/services/office-furniture" },
  { title: "Custom Furniture", image: furnitureImg, link: "/services/furniture-manufacturing" },
];
  ...
  <div>
    ...
    <section className="relative h-[90vh] min-h-[600px] flex items-center overflow-hidden">
      ...
      <div className="relative container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-2xl">
          <span className="text-primary text-sm font-semibold tracking-[0.3em] uppercase mb-4 block">Welcome to Noble Spaces</span>
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl text-foreground mb-4 leading-tight">
            Your Space,<br /><span className="text-gold-gradient">Our Passion</span>
          </h1>
          <p className="text-muted-foreground text-lg md:text-xl mb-8 max-w-lg leading-relaxed">
            Premium interior design & furniture solutions crafted with precision, elegance, and a passion for perfection.
          </p>
    ...
    <section className="py-20 bg-card">
      <div className="container mx-auto px-4">
        <SectionHeading label="What We Do" title="Signature Categories" description="Explore our most popular design categories" />
    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        <SectionHeading label="Our Services" title="Complete Solutions" description="From concept to completion, we offer a full range of interior and furniture services." />
      ...
      <div className="container mx-auto px-4">
        <AnimatedSection>
          <div className="gold-gradient rounded-3xl p-12 md:p-16 text-center">
            <h2 className="font-display text-3xl md:text-4xl text-primary-foreground mb-4">Ready to Transform Your Space?</h2>
            <p className="text-primary-foreground/80 mb-8 max-w-xl mx-auto">Let's discuss your vision. Contact us today for a free consultation and personalized quote.</p>
